...
class ParseResults:
    ...
    def as_list(self) -> list:
        ...
        Example::
            ...
            print(
                type(result), result
            )  # -> <class 'pyparsing.ParseResults'> ['sldkj', 'lsdkj', 'sldkj']
    ...
    def as_dict(self) -> dict:
        ...
        Example::
            ...
            print(
                type(result), repr(result)
            )  # -> <class 'pyparsing.ParseResults'> (['12', '/', '31', '/', '1999'], {'day': [('1999', 4)], 'year': [('12', 0)], 'month': [('31', 2)]})

            result_dict = result.as_dict()
            print(
                type(result_dict), repr(result_dict)
            )  # -> <class 'dict'> {'day': '1999', 'year': '12', 'month': '31'}
    ...
    def get_name(self):
        ...
        Example::
            ...
            user_data = (
                Group(house_number_expr)('house_number')
                | Group(ssn_expr)('ssn')
                | Group(integer)('age')
            )
